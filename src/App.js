            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-slate-800/50 border border-slate-700 p-6 sm:p-8 rounded-xl shadow-lg">
                    ...
                    <Section title="Abstract">
                        <p>This study introduces a novel statistical index for measuring disagreement—and by extension, consensus—within groups responding to Likert scale items. Traditional metrics like variance, percentage agreement, and entropy often fail to account for how the range of variance is influenced by the mean, especially when comparing groups with different central tendencies. The proposed index leverages the conditional distribution of variance given a mean, allowing for more meaningful comparisons across groups and survey items. The authors define a disagreement index (ϕ) and its complement, a consensus measure (λ = 1 − ϕ), which together provide a robust framework for evaluating group alignment. The paper outlines the mathematical foundations, demonstrates how to compute the index for a 5-point Likert scale, and compares its performance with existing measures like rwG and Cns(X). Results show that the new index offers additional insights in cases where traditional metrics may be misleading. Future work includes generalizing the method to Likert scales of any size and developing computational tools for broader application.</p>
                    </Section>
